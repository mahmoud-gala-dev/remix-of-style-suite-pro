...
export const dict = {
  ...
  gallery_sub: { en: "Before / after & portfolio images", ar: "صور قبل/بعد ومعرض الأعمال" },
  upload: { en: "Upload", ar: "رفع" },
  uploading: { en: "Uploading…", ar: "جارٍ الرفع…" },
  uploaded: { en: "Uploaded", ar: "تم الرفع" },
  caption: { en: "Caption", ar: "وصف" },
  before: { en: "Before", ar: "قبل" },
  after: { en: "After", ar: "بعد" },
  portfolio: { en: "Portfolio", ar: "معرض الأعمال" },
  purchasing: { en: "Purchasing", ar: "المشتريات" },
  purchasing_sub: { en: "Suppliers, purchase orders & auto-reorder", ar: "الموردون وأوامر الشراء وإعادة الطلب التلقائية" },
  currency: { en: "Currency", ar: "العملة" },
  currency_sub: { en: "Set the default currency for invoices & bookings", ar: "حدد العملة الافتراضية للفواتير والحجوزات" },
  currency_saved: { en: "Currency updated", ar: "تم تحديث العملة" },
  default_currency: { en: "Default currency", ar: "العملة الافتراضية" },
  supported_currencies: { en: "Supported currencies", ar: "العملات المدعومة" },
  setup_wizard: { en: "Setup wizard", ar: "معالج الإعداد" },
  setup_wizard_sub: { en: "Get your salon running in 3 quick steps", ar: "جهّز صالونك في 3 خطوات سريعة" },
  step1_branch: { en: "Create your first branch", ar: "أنشئ أول فرع" },
  step1_sub: { en: "Name, address and capacity — you can edit these later", ar: "الاسم والعنوان والسعة — يمكن تعديلها لاحقاً" },
  step2_services: { en: "Pick a template", ar: "اختر قالباً" },
  step2_sub: { en: "We'll seed a starter service menu you can customise", ar: "سنضيف قائمة خدمات مبدئية يمكنك تعديلها" },
  step3_staff: { en: "Add your first staff member", ar: "أضف أول موظف" },
  step3_sub: { en: "You can add the rest of the team anytime from Employees", ar: "يمكنك إضافة بقية الفريق لاحقاً من قسم الموظفين" },
  seed_templates: { en: "Use template", ar: "استخدم القالب" },
  finish_setup: { en: "Finish setup", ar: "إنهاء الإعداد" },
  finish_later: { en: "Finish later", ar: "إكمال لاحقاً" },
  skip: { en: "Skip", ar: "تخطي" },
  tour_label: { en: "Quick tour", ar: "جولة سريعة" },
  tour_back: { en: "Back", ar: "السابق" },
  tour_finish: { en: "Start setup", ar: "ابدأ الإعداد" },
  tour_s1_title: { en: "Welcome to Vanguard Salon OS", ar: "أهلاً بك في Vanguard Salon OS" },
  tour_s1_body: {
    en: "A 60-second tour of the four things you'll use every day. You can skip anytime.",
    ar: "جولة 60 ثانية على أهم 4 أدوات ستستخدمها يومياً. يمكنك التخطي في أي وقت.",
  },
  tour_s2_title: { en: "Switch between branches", ar: "التنقل بين الفروع" },
  tour_s2_body: {
    en: "Use the branch picker in the top bar to switch the entire app to another branch — bookings, queue, and reports update instantly.",
    ar: "استخدم منتقي الفروع في الشريط العلوي لتبديل التطبيق بأكمله إلى فرع آخر — الحجوزات وقائمة الانتظار والتقارير تتحدث فوراً.",
  },
  tour_s3_title: { en: "Navigate from the sidebar", ar: "التنقل من الشريط الجانبي" },
  tour_s3_body: {
    en: "Operations, Management, and Finance are grouped on the left. Press ⌘K (or Ctrl+K) anywhere to open the command palette.",
    ar: "العمليات والإدارة والمالية مجمعة على اليسار. اضغط ⌘K (أو Ctrl+K) في أي مكان لفتح لوحة الأوامر.",
  },
  tour_s4_title: { en: "Calendar, queue & bookings", ar: "التقويم وقائمة الانتظار والحجوزات" },
  tour_s4_body: {
    en: "Drag bookings on the calendar, manage walk-ins from the live queue, and track everything from the Bookings page.",
    ar: "اسحب الحجوزات في التقويم، وأدر العملاء بدون موعد من قائمة الانتظار المباشرة، وتابع كل شيء من صفحة الحجوزات.",
  },
  tour_s5_title: { en: "Set up your first branch", ar: "أعدّ أول فرع لك" },
  tour_s5_body: {
    en: "Ready to go live? The setup wizard creates your first branch, seeds a service template, and adds your first employee in 3 quick steps.",
    ar: "جاهز للانطلاق؟ معالج الإعداد ينشئ أول فرع، ويعبّئ قالب خدمات، ويضيف أول موظف في 3 خطوات سريعة.",
  },
  // BI
  bi: { en: "Business Intelligence", ar: "ذكاء الأعمال" },
  bi_title: { en: "Business Intelligence", ar: "ذكاء الأعمال" },
  bi_sub: { en: "Customer segments, retention cohorts, lifetime value & conversion funnel.", ar: "شرائح العملاء، فئات الاحتفاظ، القيمة الدائمة وقمع التحويل." },
  bi_customers: { en: "Active customers", ar: "العملاء الفعّالون" },
  bi_avg_ltv: { en: "Avg lifetime value", ar: "متوسط القيمة الدائمة" },
  bi_conversion: { en: "Booking → completed", ar: "حجز ← مكتمل" },
  bi_noshow_rate: { en: "No-show rate", ar: "معدل عدم الحضور" },
  bi_funnel_title: { en: "Conversion funnel", ar: "قمع التحويل" },
  bi_funnel_total: { en: "Booked", ar: "تم الحجز" },
  bi_funnel_confirmed: { en: "Confirmed", ar: "مؤكد" },
  bi_funnel_arrived: { en: "Arrived", ar: "حضر" },
  bi_funnel_completed: { en: "Completed", ar: "مكتمل" },
  bi_rfm_title: { en: "RFM segments", ar: "شرائح RFM" },
  bi_seg_champions: { en: "Champions", ar: "أبطال" },
  bi_seg_loyal: { en: "Loyal", ar: "أوفياء" },
  bi_seg_potential: { en: "Potential", ar: "محتملون" },
  bi_seg_newCustomers: { en: "New", ar: "جدد" },
  bi_seg_needsAttention: { en: "Needs attention", ar: "يحتاجون اهتماماً" },
  bi_seg_atRisk: { en: "At risk", ar: "في خطر" },
  bi_seg_hibernating: { en: "Hibernating", ar: "خاملون" },
  bi_cohort_title: { en: "Monthly retention cohorts", ar: "فئات الاحتفاظ الشهرية" },
  bi_cohort_sub: { en: "% of new customers returning M+0..M+3", ar: "% العملاء الجدد العائدين M+0..M+3" },
  bi_cohort_month: { en: "Cohort", ar: "الفئة" },
  bi_cohort_size: { en: "Size", ar: "الحجم" },
  bi_top_customers: { en: "Top 10 by LTV", ar: "أفضل 10 حسب القيمة الدائمة" },
  bi_customer: { en: "Customer", ar: "العميل" },
  bi_days: { en: "days", ar: "أيام" },
  bi_ltv: { en: "Lifetime value", ar: "القيمة الدائمة" },
  bi_empty: { en: "No data yet for this period.", ar: "لا توجد بيانات لهذه الفترة." },
  // Accounting
  accounting: { en: "Accounting", ar: "المحاسبة" },
  acc_title: { en: "Accounting", ar: "المحاسبة" },
  acc_sub: { en: "P&L, cash flow & QuickBooks/Zoho-ready journal export.", ar: "الأرباح والخسائر، التدفق النقدي وتصدير قيود يومية متوافقة مع QuickBooks/Zoho." },
  acc_revenue: { en: "Revenue", ar: "الإيرادات" },
  acc_cogs: { en: "Costs (est.)", ar: "التكاليف (تقديرية)" },
  acc_net: { en: "Net income", ar: "صافي الدخل" },
  acc_margin: { en: "Net margin", ar: "هامش الربح" },
  acc_cashflow: { en: "Daily cash flow", ar: "التدفق النقدي اليومي" },
  acc_pnl_title: { en: "Profit & Loss", ar: "الأرباح والخسائر" },
  acc_commissions: { en: "Commissions (35%)", ar: "العمولات (35%)" },
  acc_overhead: { en: "Overhead (15%)", ar: "المصاريف العامة (15%)" },
  acc_revenue_by_cat: { en: "Revenue by category", ar: "الإيرادات حسب الفئة" },
  acc_account: { en: "Account", ar: "الحساب" },
  acc_amount: { en: "Amount", ar: "المبلغ" },
  acc_export_pnl: { en: "Export P&L", ar: "تصدير P&L" },
  acc_export_journal: { en: "Export journal (CSV)", ar: "تصدير القيود (CSV)" },
  acc_estimate_note: { en: "Costs are heuristic estimates (commission 35% + overhead 15%). Wire real expense rows in /expenses for exact P&L.", ar: "التكاليف تقديرات إرشادية (عمولة 35% + مصاريف عامة 15%). أدخل المصاريف الفعلية من /expenses للحصول على P&L دقيقة." },
  // Approvals
  approvals_title: { en: "Approvals", ar: "الموافقات" },
  approvals_sub: { en: "Govern discounts, refunds, paid-invoice cancellations and other sensitive actions.", ar: "حوكمة الخصومات والمستردات وإلغاء الفواتير المدفوعة والإجراءات الحساسة." },
  approvals_empty: { en: "No approval requests in this state.", ar: "لا توجد طلبات موافقة في هذه الحالة." },
  approval_kind: { en: "Kind", ar: "النوع" },
  approval_title_col: { en: "Request", ar: "الطلب" },
  approval_when: { en: "When", ar: "متى" },
  approve: { en: "Approve", ar: "اعتماد" },
  reject: { en: "Reject", ar: "رفض" },
  approval_approved: { en: "Approved", ar: "تم الاعتماد" },
  approval_rejected: { en: "Rejected", ar: "تم الرفض" },
  approval_status_pending: { en: "Pending", ar: "بانتظار" },
  approval_status_approved: { en: "Approved", ar: "معتمد" },
  approval_status_rejected: { en: "Rejected", ar: "مرفوض" },
  approval_status_cancelled: { en: "Cancelled", ar: "ملغى" },
  approval_kind_discount: { en: "Discount", ar: "خصم" },
  approval_kind_refund: { en: "Refund", ar: "استرداد" },
  approval_kind_cancel_paid_invoice: { en: "Cancel paid invoice", ar: "إلغاء فاتورة مدفوعة" },
  approval_kind_customer_delete: { en: "Delete customer", ar: "حذف عميل" },
  approval_kind_price_override: { en: "Price override", ar: "تجاوز السعر" },
  approval_kind_other: { en: "Other", ar: "أخرى" },
  // Cost allocation
  cost_alloc_title: { en: "Cost allocation", ar: "توزيع التكاليف" },
  cost_alloc_sub: { en: "Platform spend (Worker / DB / Storage) allocated per branch for internal chargeback.", ar: "تكلفة المنصة (Worker / DB / Storage) موزعة لكل فرع للفوترة الداخلية." },
  cost_alloc_branches: { en: "Branches", ar: "الفروع" },
  cost_alloc_total_cost: { en: "Total platform cost", ar: "إجمالي تكلفة المنصة" },
  cost_alloc_total_ratio: { en: "Cost / revenue", ar: "التكلفة / الإيرادات" },
  cost_alloc_chart: { en: "Cost per branch", ar: "التكلفة لكل فرع" },
  cost_alloc_cost: { en: "Platform cost", ar: "تكلفة المنصة" },
  cost_alloc_ratio: { en: "% of revenue", ar: "% من الإيرادات" },
  cost_alloc_note: { en: "Model: $5 baseline per branch + $0.02 per booking + $0.01 per customer. Update constants in /cost-allocation if your unit economics differ.", ar: "النموذج: 5$ أساس لكل فرع + 0.02$ لكل حجز + 0.01$ لكل عميل. عدّل الثوابت في /cost-allocation إذا اختلفت اقتصاديات وحدتك." },
  ...
  expenses_sub: { en: "Track expenses & net profit", ar: "تتبع المصروفات وصافي الربح" },
  expense_added: { en: "Expense recorded", ar: "تم تسجيل المصروف" },
  category_added: { en: "Category added", ar: "تمت إضافة الفئة" },
  categories: { en: "Categories", ar: "الفئات" },
  no_categories: { en: "No categories yet", ar: "لا توجد فئات بعد" },
  no_expenses: { en: "No expenses yet", ar: "لا توجد مصروفات بعد" },
  new_category: { en: "New category", ar: "فئة جديدة" },
  record_expense: { en: "Record expense", ar: "تسجيل مصروف" },
  amount: { en: "Amount", ar: "المبلغ" },
  vendor: { en: "Vendor", ar: "المورد" },
  uncategorized: { en: "Uncategorized", ar: "بدون فئة" },
  ...
  auto_reorder_scan: { en: "Auto-reorder scan", ar: "فحص إعادة الطلب" },
  low_stock: { en: "Low stock", ar: "مخزون منخفض" },
  reorder_point: { en: "Reorder point", ar: "نقطة إعادة الطلب" },
